...
from agentverse.environments.tasksolving_env.rules.evaluator_final import (
    BaseEvaluatorFinal,
    evaluator_final_registry,
)
...
class TasksolvingRuleFinal(BaseRule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        evaluator_final = build_components(evaluator_final_config, evaluator_final_registry)    
        super().__init__(
            role_assigner=role_assigner,
            decision_maker=decision_maker,
            executor=executor,
            evaluator=evaluator,
            evaluator_final=evaluator_final,
            *args,
            **kwargs,
        )
